...
// Comments form.
add_filter( 'comment_form_default_fields', 'diamonde_bootstrap_comment_form_fields' );
 ...
 * @return array
 */
function diamonde_bootstrap_comment_form_fields( $fields ) {
	...
	$fields    = array(
		'author' => '<div class="form-group comment-form-author"><label for="author">' . __( 'Name',
				'diamonde' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
...
add_filter( 'comment_form_defaults', 'diamonde_bootstrap_comment_form' );
 ...
 * @return mixed
 */
function diamonde_bootstrap_comment_form( $args ) {
	$args['comment_field'] = '<div class="form-group comment-form-comment">
    <label for="comment">' . _x( 'Comment', 'noun', 'diamonde' ) . ( ' <span class="required">*</span>' ) . '</label>
